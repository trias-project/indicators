...
em_df <-
  ...
  relocate(.data$mean_growth, .before = .data$canonicalName)
```
...
ranking <-
  ...
  arrange(
    ...
    desc(year_2019_em_status_occupancy_pa),
    desc(year_2019_em_status_observations_pa),
    desc(year_2019_em_status_occupancy_BE),
    desc(year_2019_em_status_observations_BE),
  ...
  select(
    ...
    year_2019_em_status_occupancy_pa,
    year_2019_em_status_observations_pa,
    year_2019_em_status_occupancy_BE,
    year_2019_em_status_observations_BE,
...
We can also rank using a point strategy reflecting the same ranking strategy as before. We apply gain factors to all emerging status scores using the number of observations in 2018 in all Belgium as reference (gain factor  = 1). The following gain factors are applied:

| indicator | year | region | gain factor |
| --- | --- | --- | --- | 
occupancy | 2020 | protected areas | 3
observations | 2020 | protected areas | 2.5
occupancy | 2020 | Belgium | 2.5
observations | 2020 | Belgium | 2
occupancy | 2019 | protected areas | 2.5
observations | 2019 | protected areas | 2
occupancy | 2019 | Belgium | 2
observations | 2019 | Belgium | 1.5
occupancy | 2018 | protected areas | 2
observations | 2018 | protected areas | 1.5
occupancy | 2018 | Belgium | 1.5
observations | 2018 | Belgium | 1

```{r rank_by_em_pts}
ranking_pts <-
  em_df %>%
  mutate(em_pts = year_2020_em_status_occupancy_pa * 3 +
    year_2020_em_status_observations_pa * 2.5 +
    year_2020_em_status_occupancy_BE * 2.5 +
    year_2020_em_status_observations_BE * 2 +
    year_2019_em_status_occupancy_pa * 2.5 +
    year_2019_em_status_observations_pa * 2 +
    year_2019_em_status_occupancy_BE * 2 +
    year_2019_em_status_observations_BE * 1.5 +
    year_2018_em_status_occupancy_pa * 2 +
    year_2018_em_status_observations_pa * 1.5 +
    year_2018_em_status_occupancy_BE * 1.5 +
    year_2018_em_status_observations_BE) %>%
  arrange(
    desc(em_pts),
    desc(mean_growth)
