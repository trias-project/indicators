...
GIS data of protected areas as defined in Natura2000 can be found on related webpage of [European Environment Agency](https://www.eea.europa.eu/data-and-maps/data/natura-11#tab-gis-data). We downloaded the GIS data as shapefile in folder `data/external/Natura2000_Shapefile`:

```{r download_data}
folder_path <- here::here(
  "data",
  "external",
  "Natura2000_Shapefile")
...
if (!file.exists(path_natura2000)) {
  ...
  response <- 
    httr2::request("https://sdi.eea.europa.eu/datashare/s/NPpTTHmERYszoLX/download") %>% 
    httr2::req_url_query(
      path = "/GPKG",
      files = "Natura2000_end2022_rev1.gpkg"
    ) %>% 
    httr2::req_perform()
  # write to disk
...
## Add regional information to Belgian protected areas
