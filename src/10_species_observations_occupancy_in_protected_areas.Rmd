...
Read the occurrence cubes at species level for European countries as published on Zenodo (https://doi.org/10.5281/zenodo.3637910). It can take a long time:

```{r read_cube_from_zenodo}
if (!"be_species_cube.csv" %in%
  list.files(here::here("data", "interim"))) {
  download_zenodo(
    doi = "10.5281/zenodo.3637910",
