...
Read the geospatial package containing the Belgian protected areas:
...
Map of the protected areas with number of species included in the list of Union concern:
...
purrr::walk2(n_taxa_obs_per_area_dfs,
...
# Save data
purrr::walk2(n_prot_areas_per_species_dfs,
