---
title: "Taxonomic distribution of emerging species"
author:
- Damiano Oldoni
- Tim Adriaens
date: "`r Sys.Date()`"
...
### Number of occurrences: Belgium

Table:

```{r emerging_df_BE_occs}
emerging_df_BE_occs <-
  emerging_df %>%
...
purrr::walk2(
  ...
  function(x, y) {
    ggplot2::ggsave(here::here(
      ...
      "output",
      "taxonomic_distribution_emerging_species",
      paste0("n_emerging_taxa_per_class_in_Belgium_occs_",
             y,".png")
      ),
      x
    )
...
### Number of occurrences: Natura2000

Table:

```{r emerging_df_Natura2000_occs}
...
```{r plot_emerging_df_Natura2000_occs}
...
```{r save_emerging_Natura2000_occs}
readr::write_tsv(
  emerging_df_Natura2000_occs,
  here::here(
  "data",
...
purrr::walk2(
  ...
  function(x, y) {
    ggplot2::ggsave(here::here(
      ...
      "output",
      "taxonomic_distribution_emerging_species",
      paste0("n_emerging_taxa_per_class_in_Natura2000_occs_",
             y,".png")
      ),
      x
    )
